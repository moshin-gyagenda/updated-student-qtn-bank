        ...
        <section class="section dashboard">
            <div class="row">
                                ...
                                <div class="activity">
                                    ...
                                    <div class="activity-item d-flex">
                                        ...
                                        <div class="activity-content">
                                            Financial Management <br> <a href="#" class="fw-bold text-blue">Course
                                                Work</a>
                                        </div>
                                    ...
                                    <div class="activity-item d-flex">
                                        ...
                                        <div class="activity-content">
                                            Business Law <br> <a href="#" class="fw-bold text-blue">Final Papers</a>
                                        </div>
                                    </div><!-- End activity item-->
                ...
                @if (auth()->user()->role === 'student')
                    <section class="section dashboard">
                        <div class="row">
                            <h3>Choose Past Papers From Here</h3>
                            <div class="col-lg-12">
                                @if (session('success'))
                                        ...
                                        <div class="col-md-4">
                                            <div class="card mb-4">
                                                <div class="card-body">
                                                    ...
                                                    <a target="_blank"
                                                        href="{{ asset('past_papers/' . $pastPaper->pdf_file) }}"
