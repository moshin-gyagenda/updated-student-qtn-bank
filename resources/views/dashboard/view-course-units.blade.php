        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">View Course Unit </li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section dashboard">
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Course Unit List</h5>
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    @foreach ($course_units as $course_unit)
                                        <tr>
                                            <th scope="row">{{ $course_unit->id }}</th>
                                            <td>{{ $course_unit->courseunit }}</td>
                                            <td>{{ $course_unit->department }}</td>
                                            <td>{{ $course_unit->description }}</td>
                                            <td>
